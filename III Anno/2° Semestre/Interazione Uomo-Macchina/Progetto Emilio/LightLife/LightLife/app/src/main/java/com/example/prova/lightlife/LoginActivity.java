...
public class LoginActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (validate()) {
                    ...
                    if (currentUser != null) {
                        ...
                        User u = sqliteHelper.getUtente(Email);
                        if(u.soul.equals("Cliente")){
                            ...
                            Intent intent = new Intent(LoginActivity.this, HomePageNegoziante.class);
                            intent.putExtra("email", u.email);
                            startActivity(intent);
                            finish();
                        }
                        ...
                        Snackbar.make(buttonLogin, "Impossibile accedere, per favore riprova", Snackbar.LENGTH_LONG).show();
    ...
    private void initCreateAccountTextView() {
        ...
        textViewCreateAccount.setText(fromHtml("<font color='#000000'>Non hai ancora un account? </font><font color='#0c0099'>Registrati</font>"));
