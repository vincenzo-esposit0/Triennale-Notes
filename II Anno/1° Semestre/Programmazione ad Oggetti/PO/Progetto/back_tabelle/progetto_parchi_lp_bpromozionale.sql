...
CREATE TABLE `bpromozionale` (
  ...
  KEY `fk_bpromozione_idx` (`promozione`,`parco_promozione`),
  CONSTRAINT `fk_bpiglietto` FOREIGN KEY (`biglietto`) REFERENCES `biglietto` (`codice`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_bpromozione` FOREIGN KEY (`promozione`, `parco_promozione`) REFERENCES `promozione` (`codice`, `parco`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2017-01-17 12:41:05
